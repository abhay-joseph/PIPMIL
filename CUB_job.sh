...
python main.py --dataset 'Bisque' --validation_size 0.0 --net 'resnet18' --batch_size 5  --batch_size_pretrain 10 --epochs 60 --optimizer 'Adam' --lr 0.05 --lr_block 0.0001 --lr_net 0.0001 --weight_decay 0.0 --log_dir './runs/pipnet_bisque_207121037_2' --num_features 0 --image_size 32 --state_dict_dir_net '' --freeze_epochs 10 --dir_for_saving_images 'Visualization_results' --epochs_pretrain 10 --seed 207121037 --gpu_ids '' --num_workers 8 
